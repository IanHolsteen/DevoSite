...
export default function Example() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ouzw6ts', 'template_8upl6ke', form.current, 'GC82y4dW9do18m9NY')
      .then((result) => {
      ...
      <div className="overflow-hidden bg-midnight-200 py-12 px-6 lg:px-8 lg:py-24">
        <div className="relative mx-auto max-w-xl">
          ...
          <div className="text-center">
            ...
            {formOpen ? <p className="mt-4 text-lg leading-6 text-silver">
              Thanks for reaching out! I'll get back to you as soon as possible.
            </p> : <p className="mt-4 text-lg leading-6 text-silver">
          ...
          <div className="mt-12">
            ...
            <div className="flex items-center justify-center">
              <p className='z-10 col-span-3 mt-5 text-base px-10 text-aqua'>
